...
- (void)application:(UIApplication *)application didReceiveLocalNotification: (UILocalNotification *)notification
{
    ...
    //call notification according to type
    
    if ([[notification.userInfo objectForKey:@"type"] isEqual:@"pause"]) { //pause
        [[NSNotificationCenter defaultCenter] postNotificationName:@"pauseSong" object:nil];
    }
    else if ([[notification.userInfo objectForKey:@"type"] isEqual:@"play"]) //play
        [[NSNotificationCenter defaultCenter] postNotificationName:@"playSong" object:nil];
    else //resume
        [[NSNotificationCenter defaultCenter] postNotificationName:@"resumeSong" object:nil];
}
